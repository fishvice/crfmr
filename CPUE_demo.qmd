...
df <- read.csv("http://www.hafro.is/~einarhj/older/crfmr/data-raw/flyingfish.csv", stringsAsFactors = FALSE)
...
#ggplot(df,
#       aes(x = month, y = catch, group = month)) +
#  geom_boxplot()

#ggplot(df,
#       aes(x = year, y = catch, fill = country)) +
#  geom_boxplot()

#ggplot(df,
#       aes(x = year, y = catch, fill = vessel)) +
#  geom_boxplot() +
#  facet_wrap(~ country) 
