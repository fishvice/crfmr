...
-   Latest version of **R**: see [The Comprehensive R Archive Network](https://cran.r-project.org/)
...
### [Getting Started with RStudio](https://sfg-ucsb.github.io/fishery-manageR/getting-started-with-rstudio.html)
...
* **Code Editor**: This is where you write the code for your analysis. These could include:
  * **R code** - Plain R scripts
  * **Rmarkdown document**: A document with (or withouth) R-code.
...
* **Environment/History**: Have at minimum the following tabs:
  * **Environment**: Displays all your obtjects (data) and user-defined functions in your current session.
  * **History** - A history of your commands
* **Files/Packages/Help/Viewer**:
  * **Files** - The list of all files contained in your current *working directory*. You can also navigate to different folders on your computer. This is where you can click on different documents (R-scripts, markdown documents, ...) to open them in the code editor.
